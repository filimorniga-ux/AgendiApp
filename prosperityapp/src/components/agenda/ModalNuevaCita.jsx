...
const ModalNuevaCita = ({ isOpen, onClose, slotInfo }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-40 flex justify-center items-end sm:items-center modal-backdrop">
      <div className="bg-bg-secondary p-5 rounded-t-[20px] sm:rounded-lg shadow-xl w-full sm:max-w-md z-50 text-text-main max-h-[92dvh] overflow-y-auto modal-content">
