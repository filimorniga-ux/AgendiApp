...
export const AuthModal = ({ isDarkMode, onClose, title, children }) => (
    <div className="fixed inset-0 z-[60] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 modal-backdrop" onClick={onClose}>
        <div className={`${isDarkMode ? 'bg-[#1a202c] border border-slate-700' : 'bg-white'} w-full max-w-md rounded-3xl shadow-2xl p-8 relative modal-content`} onClick={e => e.stopPropagation()}>
